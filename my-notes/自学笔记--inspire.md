...
Day8
    ...
    刻意练习
        学英语最简单的刻意练习就是朗读。每天朗读一小时，一百天下来就会超过绝大多数人，也会超越自己原本可能永远夸不过去的那个坎——神奇的是，朗读什么无所谓，反正现在有声书那么多。。。更神奇 动手，刚开始朗读得好不好听，甚至好不好都无所谓，反正没几天就能体会到大幅进步。。。最神奇的是，这么简单的事，99.99%的人都不做——你身在中国，能理解这比例真的没有夸张。

        王渊源的微信公众号：清晨朗读会

        为什么自己笨手笨脚，biu恶人一出手就是高手？
            花在刻意练习上定时间太少；
            没有刻意思考哪些地方需要刻意练习
...
Day9
    ...
    关于参数（下）
        可以接收一系列值的位置参数
            ...
            在定义接收一系列值的位置参数时，建议在函数内部为该变量命名时总是用复数，因为函数内部，总是需要for循环去迭代元组中的元素，这样的时候，名称的复数形式对代码的可读性很有帮助————注意以上程序第二行。以中文为母语的人，在这个细节上常常感觉“不堪重负”————因为中文的名词没有复数——但必须习惯。（同样的道理，若是用拼音命名变量，就肯定是为将来挖坑。。。）
